...
export default function DigitalMarketingCoursePage() {
  ...
  const courses = Array(6).fill({
    ...
    description: "Pelajari SEO, strategi media sosial, dan iklan digital untuk pemasaran yang efektif serta tips mengoptimalkan audiens yang tepat.",
    image: "/keyboard.svg",
    isFreeRegister: true
  });
  ...
  return (
    <>
      <Head>
        <title>Kursus Digital Marketing - Chayon Online Course</title>
      </Head>
      <Navbar />
        ...
        <div className="container mx-auto px-4 mt-16">
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="text-gray-600 mb-12 text-base font-normal leading-[1.8]">
              Temukan berbagai wawasan seputar dunia digital marketing, mulai dari strategi pemasaran
              online, tren terbaru, hingga tools yang wajib dikuasai. Dapatkan informasi eksklusif serta
              kisah inspiratif dari para praktisi dan ahli di bidang digital marketing.
            </p>
          </div>
            ...
            {filteredCourses.map((course, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <Link 
                    href="/kursus/daftar/digital-marketing"
