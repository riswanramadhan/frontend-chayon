...
export default function LintasMinatPage() {
  ...
  const posts = Array(6).fill({
    ...
    description: "Pindah jalur karier bukan halangan! Pelajari skill baru dan buka peluang baru.",
    image: "/hacking.svg"
  });
        ...
        <div className="container mx-auto px-4 mt-16">
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="text-gray-600 mb-12 text-base font-normal leading-[1.8]">
              Temukan berbagai wawasan menarik dari beragam bidang lintas minat, mulai dari teknologi, seni, 
              bisnis hingga gaya hidup. Dapatkan informasi eksklusif serta kisah-inspiratif dari narasumber 
              dengan latar belakang dan keahlian yang beragam.
            </p>
          </div>
            ...
            {filteredPosts.map((post, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100">
                ...
                <div className="p-6">
                  ...
                  <Link 
                    href="/blog/berkarir-di-bidang-yang-berbeda-berani-untuk-mencoba" 
