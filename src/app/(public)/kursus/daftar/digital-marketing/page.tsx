        ...
        <div className="bg-gray-50 py-12 px-16">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center mb-4">
              <span className="bg-black text-white text-xs px-3 py-1 rounded-md mr-3">Digital Marketing</span>
              <span className="text-xs text-gray-600">FREE REGISTER</span>
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-12">Bangun Brand dan Tingkatkan Penjualan</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-100 p-8 rounded-lg">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Tentang Bangun Brand dan Tingkatkan Penjualan</h2>
                
                <p className="text-gray-700 mb-6">
                  Pelajari SEO, strategi media sosial, dan iklan digital untuk pemasaran yang efektif serta tips meningkatkan audiens yang tepat.
                </p>
