...
export default function MachineLearningPage() {
  ...
  const posts = Array(6).fill({
    ...
    description: "Pelajari cara kerja algoritma pintar yang mengubah industri dan kehidupan sehari-hari",
    image: "/ddos.svg",
  });
        ...
        <div className="container mx-auto px-4 mt-16">
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="text-gray-600 mb-12 text-base font-normal leading-[1.8]">
              ...
              penerapan dalam kehidupan nyata, hingga tren dan teknologi terbaru. Dapatkan informasi
              ekslusif serta kisah inspiratif dari para ahli dan praktisi di bidang machine learning.
            </p>
          </div>
